...
class Trending extends React.Component {
    ...
    showTrendingRepo = (data) => {
        return (
            <View>
                {/* <View style={{ height: calcHeight(6), width: calcWidth(100), backgroundColor: "#F86565",}}>
                    <Text style={{fontSize: 20, fontWeight: "bold", color: "#ffffff", marginTop: calcHeight(1), marginLeft: calcWidth(4)}}>GO</Text>
                </View> */}
                        ...
                        {this.state.loading ? (
                            ...
                            >
                                ...
                                <Button
                                    ...
                                    titleStyle={{ fontSize: 14, fontFamily: "Manrope-Bold" }}
